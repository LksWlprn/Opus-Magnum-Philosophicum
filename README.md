...
These psychophysical laws might not be as big of a burden for Panpsychism (the view that mentality is fundamental and ubiquitous in the natural world) or if one believes in some form of God having designed reality specifically for our existence in it. While I cannot see how the second thesis might be true, I can conceive of Panpsychism being true. It is said that the hardest problem for Panpsychism is subject-summing or more generally the combination problem, but within Universalism this problem is not as burdensome. The challenge consists in how the postulated micro-level conscious entities in a Panpsychist world could combine into our unified conscious experience. If Universalism is true, all the experiences of these tiny consciousnesses is already mine, so in that sense, combination isn't even needed. But another problem becomes apparent, because how would the boundary of our experience manifest and why would we not experience every micro-level entities experiences. Personally, I think that consciousness cannot be a micro-level phenomenon.
