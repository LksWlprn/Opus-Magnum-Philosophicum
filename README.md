...
In other words, if two different universes contain the exact same set of possible places where you could be (and don't have extra copies of you elsewhere), then your probability of being in any particular place should be the same in both universes. Nothing outside of those places should influence your probability judgment. For example, suppose there were 10 copies of you in this universe with qualitatively identical experiences and 10 copies in another universe with the exact same experience. Suppose further that these copies are awakened in identical rooms, which are numbered 1 to 10. ESP would tell us that our probability of being in any given room is 10%, even though there are 20 copies in total. 
