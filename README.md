...
Wolfram himself comes to the conclusion: "The set of all possible rules is something purely formal. It can be represented in an infinite number of ways. But it’s always there, existing as an abstract thing, completely independent of any particular instantiation.
...
Another powerful argument against Dualism is noticing the enormous ontological baggage of psychophysical laws which, according to Dualism, must govern the relationship between the physical and the mental world. In other words: the dualist has to explain why there are such specific laws, governing our conscious experience, relating it to what I called the soul realm. These laws would have to be fundamental, but they only come into play billions of years after the Big Bang and are strangely specific to our tiny portion of matter, energy and spacetime in a vast unconscious universe. Positing all these laws enormously violates Occam's razor when there are way simpler explanations for our mental reality.
These psychophysical laws might not be as big of a burden for Panpsychism (the view that mentality is fundamental and ubiquitous in the natural world) or if one believes in some form of God having designed reality specifically for our existence in it. While I cannot see how the second thesis might be true, I can conceive of Panpsychism being true. It is said that the hardest problem for Panpsychism is subject-summing or more generally the combination problem, but within Universalism this problem is not as burdensome. The challenge consists in how the postulated micro-level conscious entities in a Panpsychist world could combine into our unified conscious experience. If Universalism is true, all the experiences of these tiny consciousnesses are already mine, so in that sense, combination isn't even needed. But another problem becomes apparent, because how would the boundary of our experience manifest and why would we not experience every micro-level entity's experiences. Personally, I think that consciousness cannot be a micro-level phenomenon.
...
More precisely, Prinz explains what the attention-mechanism is in neurological terms. Robert Lawrence Kuhn elucidates Prinz's view: "Attention is Prinz's focus in that it “changes the flow of information allowing perceptual information to access memory systems.” Neurobiologically, he says, “this change in flow depends on synchronized neural firing. Neural synchrony is also implicated in the unity of consciousness and in the temporal duration of experience” (Prinz, 2012).
...
The attention model in our working memory is essentially the narrative we perceive as that which we are aware of. The model itself might to a great extend reside in our brain's language-processing modules, but it is highly connected to every part of our cortex. It only becomes aware of the consensus within our cortex, but might influence the voting process itself, for it might influence the shifting of attention within the cortical object spaces.
...
Kant thought that humans had some kind of inherent dignity. But where does that come from? Philosophers have tried to answer this question, but there doesn't seem to be an actual answer. It somehow just has to be there, in order to make Kantian ethics work. 
...
Under universalism the question of continuation becomes entirely irrelevant, because experience will just continue for the universal subject no matter what. 
...
Since the perfect grasp would not be paralyzed by tiny probabilities, it would likely advise us to act in ways that are robustly good across multiple reasonable models. As Bertrand Russell said, if one takes action based on a hypothesis with known uncertainty, one should choose to take an action that would not have horrible consequences if the hypothesis is false. An uncertain hypothesis cannot justify certain harm, except equal harm would be experierenced if the hypothesis was false. By focusing on actions that are robustly good, rather than trying to optimize all of your actions, you will increase your probability of alignment with the perfect grasp. Obviously you should still avoid actions that predictably lead to large suffering or risk catastrophic failure. Be sceptical of overfitting decisions to extreme, unlikely scenarios, because this often comes at a cost of more probable and pressing concerns, which, if neglected, could cause the extreme scenarios to become more likely. Probability considerations beyond a certain improbability must be discarded as absurd, because otherwise I can always justify immoral actions by appealing to hypotheticals about a 10^-1000 % probability of 10^1100 beings in extreme suffering, seemingly making this a big deal to think about such scenarios. But the probability here is best approximated to be 0, because the probability itself must have a certain probability distribution about its correctness, which must also have a high probability that 0% could be the correct probability for such an event happening.
