...
- Local binding is very strong. E.g. we cannot willfully separate the color green from the structural appearance of grass.
...
Peter van Inwagen's argument is even more precise, but I'll not explain it here. What would be required for such ultimate control though, is not an indeterministic process (as some might claim), since I would not be the cause of that either. 
